...
const gemMeanings = {
    ...
    kindness: "Kindness reflects compassion and generosity towards others.",
    resourcefulness: "Resourcefulness indicates the ability to handle situations creatively and effectively.",
    creativity: "Creativity represents the power to generate new and innovative ideas.",
    compassion: "Compassion signifies empathy and concern for the suffering of others.",
    unity: "Unity embodies togetherness and collaboration towards a common goal."
};
